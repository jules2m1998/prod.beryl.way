            ...
            <div id="kt_account_profile_details" class="collapse show">
                ...
                <VForm id="kt_account_profile_details_form" class="form" novalidate>
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label required fw-semobold fs-6">Agence name</label>
                            <!--end::Label-->

                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <Field type="text" name="company"
                                    class="form-control form-control-lg form-control-solid" placeholder="Agence name" />
                        ...
                        <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label fw-semobold fs-6">Field</label>
                            <!--end::Label-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <!--begin::Input-->
                                <Field as="select" name="language" class="form-select form-select-solid form-select-lg">
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <Field as="select" name="timezone" class="form-select form-select-solid form-select-lg">
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <Field as="select" name="currency" class="form-select form-select-solid form-select-lg">
